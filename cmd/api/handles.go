...
func (app *application) authenticate(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("requestPayload.Password:", requestPayload.Password)
	...
	if !valid {
		log.Println("invalid password attempt for user:", requestPayload.Email)
		app.errorJSON(w, errors.New("invalid credentials"), http.StatusBadRequest)
		return
	}
